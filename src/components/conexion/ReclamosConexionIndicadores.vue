          ...
          <v-card-text class="pa-4 d-flex align-center justify-space-between h-100">
            ...
            <div class="d-flex flex-column justify-center">
              ...
              <div class="text-h4 font-weight-bold text-high-emphasis">
                {{ kpi.value }}<span
                  v-if="kpi.unidad"
                  class="text-h6 text-medium-emphasis ml-1"
                >{{
                  kpi.unidad }}</span>
              </div>
              <!-- Trend Info -->
              ...
              >
                ...
                <span class="text-caption text-disabled ml-1">vs mes ant.</span>
              </div>
            </div>
...
const loadKpis = async () => {
    try {
        ...
        // Find the group related to 'DocumentacionReclamosConexion'
        const groupData = data[0]?.grupo?.find(g => g.titulo === 'DocumentacionReclamosConexion');
