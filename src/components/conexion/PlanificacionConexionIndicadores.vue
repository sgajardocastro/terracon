          ...
          <v-card-text class="pa-4 d-flex align-center justify-space-between h-100">
            ...
            <div class="d-flex flex-column justify-center">
              ...
              >
                ...
                <span class="text-caption text-disabled ml-1">vs semana ant.</span>
              </div>
            </div>
...
const loadKpis = async () => {
    try {
        ...
        // Find the group related to 'PlanificacionConexion'
        const groupData = data[0]?.grupo?.find(g => g.titulo === 'PlanificacionConexion');
