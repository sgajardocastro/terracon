...
// Mapeo flexible (considera variantes con / y tildes)
function columnMap() {
  const idxN     = findColIndex(['n° de medición/ distancia', 'n° de medicion/ distancia', 'n° de medición', 'n° de medicion'])
...
/* ============== Cálculo ============== */
// Promedio de valores válidos de 0°, 90°, 180°, 270°
